...
from core import createMachine, state, transition, reduce, interpret
...
class TestReduce(unittest.TestCase):
    ...
    def test_context_remains(self):
        ...
        self.assertDictEqual(
            service.context, {'one': 1, 'two': 2}, 'context remains')
    ...
    def test_event_second_argument(self):
        ...
        service.send('go')
        self.assertEqual(
            service.context['worked'], True, 'changed the context')
